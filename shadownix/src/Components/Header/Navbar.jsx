...
const Navbar = () => {
  ...
  return (
    <div className="w-full h-32 sm:h-24 py-2 sm:py-0 z-30 bg-white shadow-lg gap-3 sm:gap-0 shadow-black/15 flex flex-col sm:flex-row fixed top-0 sm:items-center items-stretch justify-between px-2 sm:px-8 md:px-20">
      <Link
        to={"/"}
      ...
      <nav>
        <ul className="flex items-center justify-center gap-7">
          ...
          <li className="flex items-center gap-3">
            <span className="border-[1.5px] border-[#3c2163] rounded-full p-2.5">
              <MdPhoneInTalk size={22} color="#3c2163" />
            </span>
